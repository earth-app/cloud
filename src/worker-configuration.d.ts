/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5a02bba931c91a8408799c86f0e094a0)
// Runtime types generated with workerd@1.20260401.1 2026-03-05 nodejs_compat,nodejs_zlib
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./index');
		durableNamespaces: 'LiveNotifier' | 'UserTimer';
	}
	interface Env {
		CACHE: KVNamespace;
		KV: KVNamespace;
		...
		NOTIFIER: DurableObjectNamespace<import('./index').LiveNotifier>;
		TIMER: DurableObjectNamespace<import('./index').UserTimer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, 'ADMIN_API_KEY' | 'MANTLE_URL' | 'MAPS_API_KEY' | 'ENCRYPTION_KEY'>
	> {}
}
declare module '*.csv' {
	const value: string;
